...
var onSignUpRequest = function onSignUpRequest(event) {
...
var onSignInRequest = function onSignInRequest(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.signIn(data).then(ui.signInSuccess).then(getAllUserGames).catch(ui.apiFailure);
};

var onSignOutRequest = function onSignOutRequest(event) {
  event.preventDefault();
  api.signOut().then(ui.signOutSuccess).catch(ui.apiFailure);
};

var onChangePass = function onChangePass(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.changePassword(data).then(ui.changePassSuccess).catch(ui.apiFailure);
};

var getAllUserGames = function getAllUserGames() {
  api.getGames().then(ui.getAllGamesSuccess).catch(ui.apiFailure);
};
...
var onCreateGame = function onCreateGame(event) {
  ...
  var data = getFormFields(this);
  // debugger
  api.createGame(data).then(ui.createGameSuccess).then($('#gamesDisplay').empty()).then(getAllUserGames).catch(ui.apiFailure);
};
// pre fill the game patch function with the selcted games data
var stagingGameChange = function stagingGameChange() {
  var clickedGameId = $(this).parents('.card').attr('data-game-id');

  api.getOneGame(clickedGameId).then(console.log(Response)).catch(ui.apiFailure);
};

var onGameChange = function onGameChange() {
  event.preventDefault();
  var data = getFormFields(this);
  // console.log('gameId: ' +gameId)
  // console.log('data: ' +data)
  api.updateGame(data).then(ui.gamePatchSuccess).then(getAllUserGames).catch(ui.apiFailure);
};

var onGameDelete = function onGameDelete(event) {
  var gameId = $(this).parents('.card').attr('data-game-id');
  // console.log(thisGame)
  api.destroyGame(gameId).then(ui.deleteGameSuccess).then($('#gamesDisplay').empty()).then(getAllUserGames).catch(ui.apiFailure);
};
...
module.exports = {
  ...
  stagingGameChange: stagingGameChange
};
...
var config = {
  apiOrigins: {
    production: 'https://git.heroku.com/local-league.git',
...
$(function () {
  ...
  $('#signUpToggleBtn').on('click', function () {
    $('#signUpForm').show();
...
var destroyGame = function destroyGame(data) {
  return $.ajax({
...
var store = __webpack_require__(4);
var event = __webpack_require__(3);
var gameListTemplate = __webpack_require__(16);
...
var getAllGamesSuccess = function getAllGamesSuccess(data) {
  ...
  var gamesListHtml = gameListTemplate({ games: store.games });
...
var gamePatchSuccess = function gamePatchSuccess() {
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <div class=\"card\" data-game-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n      <div class=\"card-body\">\n        <h4 class=\"card-subtitle mb-2 text-left text-muted\">Game Id: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "</h4>\n        <h4 class=\"card-subtitle mb-2 text-center text-muted\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date : stack1), depth0))
    + "</h4>\n        <h1 class=\"card-title\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.home_team : stack1), depth0))
    + "&nbsp;&nbsp;scored: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.home_score : stack1), depth0))
    + "</h1>\n        <h4 class=\"card-subtitle mb-2 text-center text-muted\">versus</h4>\n        <h1 class=\"card-title\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.away_team : stack1), depth0))
    + "&nbsp;&nbsp;scored: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.away_score : stack1), depth0))
    + "</h1>\n        <h3 class=\"card-subtitle mb-2\">Location: &nbsp;"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location : stack1), depth0))
    + "</h3>\n        <h4 class=\"text-right\">\n          <button class=\"card-link gameEditBtn\" data-toggle=\"modal\" data-target=\"#updateGameModal\">edit</button>\n          <button class=\"card-link gameDeleteBtn\">delete</button>\n        </h4>\n      </div>\n    </div>\n";
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.games : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n<!-- <li>The quick brown fox jumps over the lazy dog <button> edit </button> <button> trash </button></li> -->\n\n\n<!-- <th>Date</th>\n<th>Location</th>\n<th>Home Team</th>\n<th>Home Score</th>\n<th>Away Team</th>\n<th>Away Score</th> -->\n";
